...
from insights.utils import INSIGHT_TYPES, create_profile_visit_insight, \
    create_likes_insight, create_insights_overview, create_summary_insights, create_reposts_insight, \
...
class EventMomentInsightsAPIView(BusinessAuthenticationAPIView):
    ...
    def get(self, request):
        ...
        insights = EventMomentInsightSerializer(moment)
